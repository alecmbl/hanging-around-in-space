function [alpha,delta,lon,lat] = ground_track(a, e, i, OM, om, th0 , thG_t0, t_vect, omegaE, muP, t0)
%
% Groundtrack parameters computation for the unperturbed problem.
%
% PROTOTYPE:
...
[ time, state ] = ode113( @(t,s) ode_2bp(t,s,muP), t_vect, [r0;v0], options);
